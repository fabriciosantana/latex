...
\input{sections/01-resumo}
\input{sections/02-introducao}
\input{sections/03-fundamentacao}
\input{sections/04-caracterizacao}
\input{sections/05-proposta}
\input{sections/06-experimentos}
...
% \input{sections/09-apendice-a}
% \input{sections/10-apendice-b}
% \input{sections/11-apendice-c}
\end{document}
