...
\addcontentsline{toc}{section}{APÊNDICE \Alph{section} -- EXEMPLO DE INTERAÇÃO MANUAL E DISCUSSÃO QUALITATIVA}
\begin{center}
\textbf{APÊNDICE \Alph{section} -- EXEMPLO DE INTERAÇÃO MANUAL E DISCUSSÃO QUALITATIVA}
\end{center}
\label{sec:apendice-interacao}

Este apêndice reúne um exemplo completo de interação manual utilizado para complementar a demonstração qualitativa apresentada na seção de experimentos. O objetivo é tornar auditável, em formato legível, uma resposta considerada representativa de bom desempenho em consulta temática delimitada.
