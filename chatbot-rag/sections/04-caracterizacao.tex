...
Desse modo, o chatbot legislativo com RAG proposto neste trabalho procura enfrentar essa lacuna ao acrescentar uma camada de mediação informacional que combina recuperação semântica, contextualização documental e geração textual ancorada em evidências.
