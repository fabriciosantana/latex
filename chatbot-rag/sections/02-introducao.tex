...
O objetivo geral deste trabalho é desenvolver e demonstrar uma prova de conceito reprodutível de chatbot legislativo baseada em RAG para consulta a discursos parlamentares da 56\textordfeminine{} Legislatura do Senado Federal, com foco na produção de respostas fundamentadas em evidências recuperadas e compatíveis com exigências de verificação institucional.
