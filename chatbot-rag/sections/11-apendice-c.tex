...
Este apêndice registra o prompt configurado no modelo RAG do Open WebUI\footnote{\url{https://github.com/fabriciosantana/mcdia/blob/main/05-iag/4-project/eval/prompts/rag_prompt.md}}, associado ao uso interativo do sistema na própria plataforma e à bateria automatizada mais recente. O prompt explicita o núcleo metodológico adotado no experimento: fidelidade ao contexto recuperado, controle de escopo, reconhecimento de limites, cautela no uso de conhecimento externo e orientação à auditabilidade.
